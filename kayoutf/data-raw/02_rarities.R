...
tf01_rarities <- tribble(
  ~rarity_code, ~rarity_name_en, ~rarity_name_zh, ~card_count, ~sort_order, ~notes,
  "BP",   "Box-Pull",             NA_character_,  6L, 1L, "AR/Augmented Reality phone integration cards",
  "LR",   "Limited Rare",         NA_character_,  7L, 2L, NA_character_,
  "AR",   "Augmented Reality",    NA_character_,  8L, 3L, NA_character_,
...
tf03_rarities <- tribble(
  ...
  "AR",   "Augmented Reality",    NA_character_,  9L, 4L, "Confirmed /009 denominator",
